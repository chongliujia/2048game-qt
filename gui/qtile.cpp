...
void QTile::draw(){
    if(tile == NULL){
        ...
        case 2:
            setStyleSheet("QTile { background: rgb(238, 228, 218); color: rgb(119, 110, 101); font: blod; border-radius: 10px; font: 40pt; }");
            break;

        case 4:
            setStyleSheet("QTile { background: rgb(238, 224, 200); color: rgb(119, 110, 101); font: bold; border-radius: 10px; font: 40pt; }");
            break;
        ...
        case 64:
            setStyleSheet("QTile { background: rgb(245, 95, 60); color: rgb(255, 255, 255); font: bold; border-radios: 10px; font: 40pt; }");
            break;
